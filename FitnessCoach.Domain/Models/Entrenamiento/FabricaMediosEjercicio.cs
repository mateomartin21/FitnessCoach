namespace FitnessCoach.Domain.Models.Entrenamiento
{
    ...
    {
        /// <summary>
        /// Último eslabón: un asset propio que siempre existe. Es un sprite de Koda y no el
        /// logo viejo de <c>branding/</c>, que era del naranja de antes de la identidad pixel
        /// y desentonaba justo cuando la imagen fallaba (D-31).
        /// </summary>
