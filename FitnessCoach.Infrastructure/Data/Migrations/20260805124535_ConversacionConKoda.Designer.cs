...
namespace FitnessCoach.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260805124535_ConversacionConKoda")]
    partial class ConversacionConKoda
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessCoach.Domain.Models.Coaching.MensajeCoach", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UsuarioPerfilId", "Id");

                    b.ToTable("MensajesCoach", (string)null);
                });
            ...
            modelBuilder.Entity("FitnessCoach.Domain.Models.Coaching.MensajeCoach", b =>
                {
                    b.HasOne("FitnessCoach.Domain.Models.UsuarioPerfil", null)
                        .WithMany()
